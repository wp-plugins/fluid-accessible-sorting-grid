...
function FluidAccessibleSortingGrid_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_FluidAccessibleSortingGrid') ) {
        wp_register_script('InfusionAll', ( get_bloginfo('wpurl') . '/wp-content/plugins/FluidAccessibleSortingGrid/lib/InfusionAll.js'));
        wp_enqueue_script('InfusionAll');

        wp_register_script('FluidAccessibleSortingGrid', ( get_bloginfo('wpurl') . '/wp-content/plugins/FluidAccessibleSortingGrid/lib/FluidAccessibleSortingGrid.js'));
        wp_enqueue_script('FluidAccessibleSortingGrid');

        wp_register_style('FluidAccessibleSortingGrid_css', ( get_bloginfo('wpurl') . '/wp-content/plugins/FluidAccessibleSortingGrid/lib/FluidAccessibleSortingGrid.css'));
